...
Command-line interface for controlling RM-01 network sharing
...
if platform.system() == 'Darwin':  # macOS
    from network_service_macos import MacOSNetworkService as NetworkService, NetworkInterface
elif platform.system() == 'Windows':
    try:
        from network_service_windows import WindowsNetworkService as NetworkService, NetworkInterface
    except ImportError:
        print("Error: Windows network service not found. Please ensure you're in the correct directory.")
        sys.exit(1)
else:  # Linux
    ...
    def __init__(self, lang=None):
        ...
        self._strings = {
            'en': {
                ...
                'trouble2': "Check System Settings → Network for AX88179A" if platform.system() == 'Darwin' else "Check 'lsusb | grep -i asix' for the device",
                'trouble3': "Check 'networksetup -listallhardwareports'" if platform.system() == 'Darwin' else "Check 'ip link show' for network interfaces",
            ...
            'zh': {
                ...
                'trouble2': "检查系统设置 → 网络中的 AX88179A" if platform.system() == 'Darwin' else "检查 'lsusb | grep -i asix' 查看设备",
                'trouble3': "检查 'networksetup -listallhardwareports'" if platform.system() == 'Darwin' else "检查 'ip link show' 查看网络接口",
